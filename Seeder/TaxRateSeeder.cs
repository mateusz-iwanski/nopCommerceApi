...
namespace nopCommerceApi.Seeder
{
    ...
    public class TaxRateSeeder
    {
        ...
        public void Seed()
        {
            ...
            var taxCategory23 = _context.TaxCategories.FirstOrDefault(tc => tc.Name == "PL_23_procent_podstawowa");
            var taxCategory23Id = taxCategory23?.Id ?? throw new BadRequestException("Default tax category \"PL_23_procent_podstawowa\" not exists, use TaxCategorySeeder.");
            ...
            var taxCategory8 = _context.TaxCategories.FirstOrDefault(tc => tc.Name == "PL_8_procent_podstawowa");
            var taxCategory8Id = taxCategory8?.Id ?? throw new BadRequestException("Default tax category \"PL_8_procent_podstawowa\" not exists, use TaxCategorySeeder.");
