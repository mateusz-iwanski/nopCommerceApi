...
namespace nopCommerceApi.Validations.ProductAttribute
{
    ...
    /// </summary>
    public class ProductAttributeDtoBaseValidator<T> : BaseValidator<T> where T : ProductAttributeValueDto
    {
        private readonly NopCommerceContext _context;
        private readonly IMySettings _settings;

        public ProductAttributeDtoBaseValidator(NopCommerceContext context, IMySettings settings)
        {
            _context = context;
            _settings = settings;
